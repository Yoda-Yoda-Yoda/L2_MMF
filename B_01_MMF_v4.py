...
while tickets_sold < MAX_TICKETS:
    ...
    # add name, ticket cost amd surcharge
...
# Calculate the total payable fpr each ticket
...
ticket_won = winner_ticket_price + winner_surcharge
...
final_total_paid_string = f"Total Paid is now ${total_paid - profit_won:.2f}"
...
adjusted_sales_heading = make_statement("Adjusted Sales & Profits",
                                        "-")
...
# Print area
print()
for item in to_write:print(item)
